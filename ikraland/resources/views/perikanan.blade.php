  ...
  <header class="sticky top-0 z-50 bg-white shadow-md">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
      ...
      <nav id="navMenu" class="hidden md:flex items-center space-x-1 lg:space-x-2">
        <a href="{{ url('/pertanian') }}" class="px-3 py-2 text-sm font-medium rounded-md hover:text-green-600 transition-colors">Pertanian</a>
        <a href="{{ url('/perikanan') }}" class="px-3 py-2 text-sm font-medium rounded-md text-green-600 font-bold">Perikanan</a>
      </nav>
    </div>
